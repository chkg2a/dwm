...
static const Key keys[] = {
    ...
    // } }, { MODKEY,			XK_p,			spawn,
    // {.v = (const char*[]){ "mpc", "toggle", NULL } } }, { MODKEY|ShiftMask,
    // XK_p,			spawn,		SHCMD("mpc pause; pauseallmpv")
    // }, { MODKEY,			XK_bracketleft,		spawn,
    // {.v = (const char*[]){ "mpc", "seek", "-10", NULL } } }, { MODKEY|ShiftMask,		XK_bracketleft,		spawn,		{.v = (const char*[]){ "mpc", "seek", "-60", NULL } } },
    // { MODKEY,			XK_bracketright,	spawn,
    // {.v = (const char*[]){ "mpc", "seek", "+10", NULL } } }, { MODKEY|ShiftMask,		XK_bracketright,	spawn,		{.v = (const char*[]){ "mpc", "seek", "+60", NULL } } },
    ...
    {MODKEY | ShiftMask, XK_s, spawn,
     SHCMD("/home/xrenne/.local/bin/takess-select")},
    ...
    /* { MODKEY|ShiftMask,		XK_x,		spawn,
       SHCMD("") }, */
    // { MODKEY,			XK_c,		spawn,		{.v =
    // (const char*[]){ TERMINAL, "-e", "profanity", NULL } } },
    ...
    {MODKEY | ShiftMask, XK_m, spawn,
     SHCMD("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle; kill -44 $(pidof "
           "dwmblocks)")},
    // { MODKEY,			XK_comma,	spawn,		{.v =
    // (const char*[]){ "mpc", "prev", NULL } } }, { MODKEY|ShiftMask,
    // XK_comma,	spawn,		{.v = (const char*[]){ "mpc", "seek",
    // "0%", NULL } } }, { MODKEY,			XK_period,	spawn,
    // {.v = (const char*[]){ "mpc", "next", NULL } } }, { MODKEY|ShiftMask,
    // XK_period,	spawn,		{.v = (const char*[]){ "mpc", "repeat",
    // NULL } } },
    ...
    // -1 } }, { MODKEY|ShiftMask,		XK_Page_Up,	shifttag,
    // { .i = -1 } }, { MODKEY,			XK_Page_Down,	shiftview,
    // { .i = +1 } }, { MODKEY|ShiftMask,		XK_Page_Down,
    // shifttag,	{ .i = +1 } }, { MODKEY,
    // XK_Insert,	spawn,		SHCMD("xdotool type $(grep -v '^#'
    ...
    // (const char*[]){ "mounter", NULL } } }, { MODKEY,
    // XK_F10,		spawn,		{.v = (const char*[]){ "unmounter", NULL
    // } } }, { MODKEY,			XK_F11,		spawn,
